...
(function (window, $, getAction) {
    ...
    window.fetch = async (...args) => {
        ...
        const response = await originalFetch(...args); if (response.url.includes('christmas_town.php?q=miniGameAction') && args[1].body.includes('{"gameType":"gameGiftShop","action":"getItems"}')) {
